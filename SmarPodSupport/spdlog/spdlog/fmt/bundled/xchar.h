...
void vformat_to(buffer<Char>& buf, basic_string_view<Char> fmt,
                basic_format_args<buffered_context<Char>> args, locale_ref loc = {}) {
...
auto vformat(basic_string_view<Char> fmt, basic_format_args<buffered_context<Char>> args)
...
auto vformat_to(OutputIt out, const S& fmt, basic_format_args<buffered_context<Char>> args)
    -> OutputIt {
