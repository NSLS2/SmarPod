...
class is_variant_formattable {
    ...
    public:
        static constexpr bool value =
            decltype(check(std::make_index_sequence<std::variant_size<Variant>::value>()))::value;
};

#endif  // FMT_CPP_LIB_VARIANT

#if FMT_USE_RTTI
inline auto normalize_libcxx_inline_namespaces(string_view demangled_name_view, char* begin)
    -> string_view {
...
auto write_demangled_name(OutputIt out, const std::type_info& ti) -> OutputIt {
    ...
    if (demangled_name_ptr) {
        demangled_name_view =
            normalize_libcxx_inline_namespaces(demangled_name_ptr.get(), demangled_name_ptr.get());
    } else {
...
struct formatter<
    ...
    enable_if_t<is_formattable<remove_cvref_t<T>, Char>::value &&
                !detail::has_format_as<T>::value && !detail::has_format_as_member<T>::value>>
