...
class qt_color_sink : public base_sink<Mutex> {
    ...
    protected:
        ...
        // It is a static method to ensure that it is handled correctly even if the sink is
        // destroyed prematurely before it is invoked.
        ...
        static void invoke_method_(invoke_params params) {
            ...
            // if color range not specified or not not valid, just append the text with default
            // color
            ...
            cursor.insertText(params.payload.mid(
                params.color_range_start, params.color_range_end - params.color_range_start));
